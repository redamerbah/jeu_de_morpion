    ...
    public void initialize() throws InterruptedException, IOException{
		try {
			...
			this.epochs = 10000;
	            ...
	            Parent root = null;
				try {
					root = FXMLLoader.load(getClass().getResource("/application/view/StartGameIA.fxml"));
				} catch (IOException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
	            
	            Stage window=(Stage) LoadingToStartGame.getScene().getWindow();
	            window.setTitle("Jouer contre l'IA");
	            window.setScene(new Scene(root));
	             * 
	             * Stage window=(Stage) FinishLoading.getScene().getWindow();
